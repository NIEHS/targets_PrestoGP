...
NAWQA.files <- c(
  "input/NAWQA_Pesticides/EPest.county.estimates.2000.txt",
...
dt$FIPS <- paste0(
  stringr::str_pad(dt$STATE_FIPS_CODE, 2, side = "left", pad = "0"),
...
centroids$FIPS <- paste0(
  stringr::str_pad(centroids$STATE_FIPS_CODE, 2, side = "left", pad = "0"),
...
NAWQA.wide <- pivot_wider(NAWQA.sf,
  id_cols = c("FIPS"),
