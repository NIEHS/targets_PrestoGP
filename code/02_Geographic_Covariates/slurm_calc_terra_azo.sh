...
#SBATCH --job-name=calc_azo_terraclimate
#SBATCH --error=calc_azo_terraclimate.error
...
apptainer exec \
    ...
    /ddn/gs1/group/set/Projects/PrestoGP_Pesticides/input/Rspatial_container/rocker_base_computation.sif Rscript /ddn/gs1/home/songi2/projects/PrestoGP_Pesticides/code/02_Geographic_Covariates/Preprocessing_TerraClimate.r
