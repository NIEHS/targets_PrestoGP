---
title: "Calc_OLM_HUC08_Raster_Covariates"
...
WBD <- st_read("/Volumes/SHAG/WBD-National/WBD_National_GDB.gdb",layer = "WBDHU8")
...
for (i in 1:length(huc08.unique)){
  ...
  HUC.rast.vals[idx.row,2:ncol(HUC.rast.vals)] <- huc08.val
...
sf::st_write(data.AZO.HUC08.OLM,"/Volumes/SHAG/PrestoGP_Covariates/AZO_HUC08_OLM.gpkg")
